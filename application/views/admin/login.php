...
<center>
  ...
  <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div>
                <form role="form" class="col s12" action="<?php echo base_url() . 'admin/login_validation'; ?>" method="post">

                <div class="row">
                        <div class="input-field col s4 push-s4">
                        <input id="username" class="form-control" name="username" value="<?= set_value('username') ?>"  type="text"><!--autofocus is where a form is automatically selected-->
