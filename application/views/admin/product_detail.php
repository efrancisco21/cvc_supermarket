                        ...
                        <div class="col-xs-6 col-md-6">
                            ...
                            <div class="jumbotron" style="height: 400px;">
                             ...
                             <div class="form-group">
                                    ...
                                    <?php
                                    echo form_open('admin/add_featured');
                                    echo form_hidden('id', $r->Menu_ID);
                                    echo form_hidden('name', $r->Menu_name);
                                    echo form_hidden('picture', $r->Menu_image);
                                    echo form_hidden('description', $r->Description);
                                    echo form_hidden('category', $r->Category);

                                    echo form_submit('submit', 'Add to featured', 'class="btn btn-success"');
                                    echo form_close();
                                    ?>
                                    <br>
