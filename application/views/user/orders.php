                                            ...
                                            foreach ($orders as $order) {
                                                ...
                                                <tr class = "odd gradeX">
                                                    ...
                                                    if ($order->status == 0) {
                                                        ...
                                                        echo "<td>" . $order->date_exp . "</td>";
                                                        {
                                                            ?>
                                                            <td>

                                                                      <a class="waves-effect waves-light btn blue lighten-1" style="color: white" href="<?php echo base_url('user/view_order_detail/' . $order->orderid); ?>">
                                                                          <span class="glyphicon glyphicon-upload"></span> View Details</a>


                                                                      <a  class="waves-effect waves-light btn green lighten-1" style="color: white" href="<?php echo base_url('billing/payment_view/' . $order->orderid); ?>">
                                                                          <span class="glyphicon glyphicon-upload"></span> Pay Order</a>


                                                                      <a  class="waves-effect waves-light btn red lighten-1" style="color: white" href="<?php echo base_url('user/cancel_order/' . $order->orderid); ?>">
