                         ...
                         <div class="col s12 m3">
                           ...
                           <center>
                                    ...
                                    <b><h4>₱<?php echo $product->Price; ?></h4>
                                        <small> <?php
                                            echo "<a href='" . site_url('user/product_detail/' . $product->Menu_ID) . "'>$product->Menu_name</a>";
                                            ?> </small></b>
                                            <br>
                                            <small> <b>Category: </b><?php echo $product->Category; ?></small>
                                            <br>

                                            <b>Stocks: <?php echo$product->Quantity?></p>
                                        </small></b>
                                        </center>
                            ...
                            if ($product->Quantity != 0) {
                                ...
                                echo form_hidden('start_price', $product->Start_Price);
